...
def main_etl(gene_path, meta_path_1, meta_path_2):

    #from import_parse
    gene_df = import_parse.read_gene(p("raw", gene_path))
    metadata_1 = import_parse.parse_series_matrix(p("raw", meta_path_1))
    metadata_2 = import_parse.parse_series_matrix(p("raw", meta_path_2))
